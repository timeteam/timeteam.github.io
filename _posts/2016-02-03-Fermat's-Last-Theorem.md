...
*  Given that none of the mathematical tools used by **Wiles** and colleagues were available to **Fermat**, and that the eventual proof ran to over a hundred highly technical pages, the obvious question arises: Did **Fermat** really have a proof, as he stated but never published?  Either **Fermat** was wrong, or, tantalisingly, perhaps another simpler proof using 17th century mathemtaical techniques exists and awaits rediscovery.  **Singh** spends a very few concluding words on this, without committing to an opinion.  It is tempting to hope that **Fermat**'s simpler proof exists and will one day be demostrated. 
